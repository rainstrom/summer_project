...
softmax_digits = vgg16.inference(batch_data, keep_prob=1.0, train_conv123=False, train_conv45=False, train_fc67=False)
...
if not only_full_test:
    ...
    for i in range(total_steps):
        ...
        print("running")
        (_, loss_value, acc_value, step, lr_value) = sess.run([train_op, cross_entropy_loss, accuracy, global_step, lr], feed_dict={batch_data:data, batch_label:label, lstm_keep_prob: 1.0})
